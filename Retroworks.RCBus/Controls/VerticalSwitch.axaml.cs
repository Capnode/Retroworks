...
namespace Retroworks.RCBus.Controls
{
    ...
    public class VerticalSwitch : ToggleButton
    {
        private Panel? _knobsPanel;
        private Panel? _switchKnob;
        private bool _knobsPanelPressed = false;
        private Point _switchStartPoint = new Avalonia.Point();
        private double _initLeft = -1;
        private bool _isDragging = false;

        static VerticalSwitch()
        {
            OffContentProperty.Changed.AddClassHandler<VerticalSwitch>((x, e) => x.OffContentChanged(e));
            OnContentProperty.Changed.AddClassHandler<VerticalSwitch>((x, e) => x.OnContentChanged(e));
            IsCheckedProperty.Changed.AddClassHandler<VerticalSwitch>((x, e) =>
            {
            ...
            BoundsProperty.Changed.AddClassHandler<VerticalSwitch>((x, e) =>
            {
                if (x.IsChecked != null)
                {
            ...
            KnobTransitionsProperty.Changed.AddClassHandler<VerticalSwitch>((x, e) =>
            {
        ...
        public static readonly StyledProperty<object?> OffContentProperty =
         AvaloniaProperty.Register<VerticalSwitch, object?>(nameof(OffContent), defaultValue: "Off");
        ...
        public static readonly StyledProperty<IDataTemplate?> OffContentTemplateProperty =
            AvaloniaProperty.Register<VerticalSwitch, IDataTemplate?>(nameof(OffContentTemplate));

        /// <summary>
        /// Defines the <see cref="OnContent"/> property.
        /// </summary>
        public static readonly StyledProperty<object?> OnContentProperty =
            AvaloniaProperty.Register<VerticalSwitch, object?>(nameof(OnContent), defaultValue: "On");
        ...
        public static readonly StyledProperty<IDataTemplate?> OnContentTemplateProperty =
            AvaloniaProperty.Register<VerticalSwitch, IDataTemplate?>(nameof(OnContentTemplate));

        /// <summary>
        /// Defines the <see cref="KnobTransitions"/> property.
        /// </summary>
        public static readonly StyledProperty<Transitions> KnobTransitionsProperty =
            AvaloniaProperty.Register<VerticalSwitch, Transitions>(nameof(KnobTransitions));
        ...
        private void KnobsPanel_PointerPressed(object? sender, Avalonia.Input.PointerPressedEventArgs e)
        {
        ...
        private void KnobsPanel_PointerReleased(object? sender, Avalonia.Input.PointerReleasedEventArgs e)
        {
            if (_isDragging)
            {
                e.Handled = true;
        ...
        private void KnobsPanel_PointerMoved(object? sender, Avalonia.Input.PointerEventArgs e)
        {
        ...
        private void UpdateKnobPos(bool value)
        {
            if ((_switchKnob != null) && (_knobsPanel != null))
            {
                if (value)
                {
                    Canvas.SetBottom(_knobsPanel, _switchKnob.Bounds.Width);
                }
                else
                {
                    Canvas.SetBottom(_knobsPanel, 0);
                }
            }
        }
    }
