...
namespace Retroworks.RCBus.Controls
{
    public class VirtualTerminalControl : TemplatedControl
    {
        ...
        protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
        {
            ...
            _panel = e.NameScope.Find<Panel>("Panel");
            _scrollBar = e.NameScope.Find<ScrollBar>("ScrollBar");
        ...
        private void SetScrollWindow()
        {
            if (Terminal != null && _scrollBar != null)
            {
                ...
                _scrollBar.ViewportSize = _panel.Bounds.Height;
            }
        }
        ...
        protected override void OnPointerMoved(PointerEventArgs e)
        {
            ...
            if (position.Column < 0 || position.Row < 0 || position.Column >= Columns || position.Row >= Rows) return;
        ...
        private void PaintBackgroundLayer(DrawingContext context, List<VtNetCore.VirtualTerminal.Layout.LayoutRow> spans)
        {
            if (spans == null)
            {
        ...
        private void PaintTextLayer(DrawingContext context, List<VtNetCore.VirtualTerminal.Layout.LayoutRow> spans, Typeface textFormat, bool showBlink)
        {
            if (spans == null)
            {
                return;
        ...
        private void PaintCursor(DrawingContext context, List<VtNetCore.VirtualTerminal.Layout.LayoutRow> spans, Typeface textFormat, TextPosition cursorPosition, IBrush cursorColor)
        {
        ...
        public override void Render(DrawingContext context)
        {
            ...
            List<VtNetCore.VirtualTerminal.Layout.LayoutRow> spans = null;
        ...
        private void AnnotateView(DrawingContext context)
        {
            ...
            for (var i = 0; i < Rows; i++)
            {
                ...
                context.DrawLine(new Pen(Brushes.Beige), new Point(0, y), new Point(_panel.Bounds.Size.Width, y));
                ...
                context.DrawText(textLayout, new Point(_panel.Bounds.Size.Width - CharacterWidth / 2 * s.Length, y));
                ...
                context.DrawText(textLayout, new Point(_panel.Bounds.Size.Width - CharacterWidth / 2 * (s.Length + 3), y));
            }
            ...
            context.DrawText(bigTextLayout, new Point(_panel.Bounds.Size.Width - bigTextLayout.Width - 100, 0));
        }
        ...
        private void ProcessTextFormat(DrawingContext drawingSession, Typeface format)
        {
            ...
            int columns = Convert.ToInt32(Math.Floor(_panel.Bounds.Size.Width / CharacterWidth));
            int rows = Convert.ToInt32(Math.Floor(_panel.Bounds.Size.Height / CharacterHeight));
            if (Columns != columns || Rows != rows)
            {
                ...
                if (Connection != null)
                    Connection.SetTerminalWindowSize(columns, rows, (int)_panel.Bounds.Width, (int)_panel.Bounds.Height);
            }
        }
