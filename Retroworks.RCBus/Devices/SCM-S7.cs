...
/// <summary>
/// https://smallcomputercentral.com/firmware/firmware-scm-s7/
/// </summary>
public class SCM_S7 : IEmulatorDevice
{
    ...
    private const ushort AciaPort1 = 0x80;
    private const ushort AciaPort2 = 0x40;
    private const ushort CfCardPort = 0x10;
    private const ushort DigitalIoPort = 0x00;
    ...
    public void Initialize(TxData txData, string? cfPath)
    {
        ...
        _processor.RegisterInterruptSource(_acia);
        _ide = new IDE(CfCardPort, 0, cfPath);
    }
    ...
    private byte ReadPort(ushort port)
    {
        ...
        value &= _ide?.ReadPort(port) ?? FloatingBus;
