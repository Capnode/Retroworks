...
/// <summary>
/// https://smallcomputercentral.com/firmware/firmware-scm-s8/
/// </summary>
public class SCM_S8 : IEmulatorDevice
{
    ...
    private const ushort StatusPort = 0x08;
    ...
    public void Initialize(TxData rxData, string? cfPath)
    {
        ...
        _acia = new ACIA_6850(AciaPort1, rxData);
    }
