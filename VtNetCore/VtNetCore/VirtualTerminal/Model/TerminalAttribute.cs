namespace VtNetCore.VirtualTerminal.Model
{
    ...
    {
        public static ETerminalColor DefaultForeground = ETerminalColor.Green;
        public static ETerminalColor DefaultBackground = ETerminalColor.Black;
        ...
        private ushort InternalBits =
            (ushort)((ushort)DefaultForeground |     // ForegroundColor
            ((ushort)DefaultBackground << 3));      // BackgroundColor
